...
// import {LocationService, AutoCompleteResult, PlaceDetail} from '.../';
import { v4 as uuidv4 } from 'uuid';
import {ClickOutsideDirective} from './click-outside.directive';
import {AutoCompleteResult, LocationService, PlaceDetail} from '../../service/location.service';
...
export class LocationSearchComponent implements OnInit {
  ...
  clearInput() {
    ...
    if(this.type == 'PICKUP'){
      this.sharedLocationService.updatePickupSourceLocation(null);
    }
  ...
  ngOnInit() {
    console.log(this.type + ' constructor field ');
    ...
    this.searchControl.valueChanges.pipe(
      ...
      value => {
        console.log('value change triggered',  value)
